                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-3 gap-4 mb-4">
                            ...
                            <input
                                type="number"
                                placeholder="Price"
                                className="border border-gray-300 col-span-1 p-2 rounded text-sm w-full dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:outline-none focus:border-[#fecb02] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                            />
                        </div>
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                            <select className="border border-gray-300 p-2 rounded text-sm w-full dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:outline-none focus:border-[#fecb02]">
                        ...
                        {/* Editor / Textarea */}
                        <div className="mb-6">
                            {/* Nếu bạn dùng TinyMCE/ReactQuill thì thay thế textarea này */}
                            <textarea
                                rows={5}
                                placeholder="This is a textarea"
                                className="w-full border border-gray-300 rounded p-2 text-sm dark:bg-gray-800 dark:text-white dark:border-gray-600"
                            ></textarea>
                        </div>
