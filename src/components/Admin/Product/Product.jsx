                    ...
                    <div class="flex flex-wrap items-end gap-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div className="flex items-center gap-2">
                                <input type="number" placeholder="₫ FROM" className="border px-2 py-2 rounded w-20 outline-none focus:border-[#fecb02] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                                <span>-</span>
                                <input type="number" placeholder="₫ TO" className="border px-2 py-2 rounded w-20 outline-none focus:border-[#fecb02] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                            </div>
                        </div>
